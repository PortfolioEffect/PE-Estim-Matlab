% Kernel Realized Variance with Rolling Window
%
%
...
% variance_krvRolling(estimatorExample,'ParzenKernel',1,23400)
function [ result ] = variance_krvRolling( estimator,kernelName, bandwidth ,wLength)
switch kernelName
    case 'BartlettKernel'
        kernelName='BARTLETT';
    case 'CubicKernel'
...
result=estimator_metric(estimator,'metric','Rol_KRV','wLength',int16(wLength),'kernelTypeName',kernelName,'bandwidth',int16(bandwidth));
end
